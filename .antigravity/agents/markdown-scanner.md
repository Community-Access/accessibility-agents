...
tools: [read, edit, search, agent, execute, askQuestions]
maxTurns: 20
---
...
**Translate mode - known translations:**
 Launch |  Done |  Warning |  Error |  Note |  Tip |  Configuration |  Documentation |  Goal |  New |  Search |  Tools |  Hello |  Celebration | ⭐ Featured |  Discussion |  Home |  Data |  Security |  Web |  Package |  Link |  Checklist |  Achievement |  Quick |  Approved |  Rejected |  Bug |  Collaboration |  Learning |  Key |  Pinned | ℹ Info |  Refresh |  Add |  Remove |  Code |  Notification |  Announcement |  Test |  Design |  Highlight |  Increase |  Decrease |  Build
