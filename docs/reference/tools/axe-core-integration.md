...
Each issue type, with its agents, axe-core and manual testing.
...
Each tool, with its axe-core usage.
...
Each scenario, with its axe-core CLI and playwright + axe-core.
