...
Each source, with its confidence.
...
- [lighthouse-scanner Skill](../knowledge-domains/lighthouse-scanner.md) -- knowledge domain reference
- [lighthouse-bridge Agent](../skills/lighthouse-bridge.md) -- agent documentation
- [web-accessibility-wizard](../skills/web-accessibility-wizard.md) -- primary consumer of lighthouse-bridge data
