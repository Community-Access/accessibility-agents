...
Each PDF field type, with its pdf-lib class and HTML output.
...
Each parameter, with its type, required and description.
...
Each form type, with its support level and notes.
...
Each connection, with connect to and when.

| Connect to | When |
|------------|------|
| [pdf-accessibility](../skills/pdf-accessibility.md) | Scan the source PDF for accessibility issues before conversion |
| [forms-specialist](../skills/forms-specialist.md) | Review the generated HTML form for additional accessibility improvements |
| [web-issue-fixer](../skills/web-issue-fixer.md) | Apply fixes to the generated HTML if issues are found |
