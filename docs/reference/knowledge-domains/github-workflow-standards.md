...
All 20 GitHub workflow agents: [github-hub](../skills/github-hub.md), [nexus](../skills/nexus.md), [daily-briefing](../skills/daily-briefing.md), [issue-tracker](../skills/issue-tracker.md), [pr-review](../skills/pr-review.md), [analytics](../skills/analytics.md), [repo-admin](../skills/repo-admin.md), [team-manager](../skills/team-manager.md), [contributions-hub](../skills/contributions-hub.md), [insiders-a11y-tracker](../skills/insiders-a11y-tracker.md), [repo-manager](../skills/repo-manager.md), [template-builder](../skills/template-builder.md), [projects-manager](../skills/projects-manager.md), [actions-manager](../skills/actions-manager.md), [security-dashboard](../skills/security-dashboard.md), [release-manager](../skills/release-manager.md), [notifications-manager](../skills/notifications-manager.md), [wiki-manager](../skills/wiki-manager.md).
...
`skills/kb-github-workflow-standards/SKILL.md`
