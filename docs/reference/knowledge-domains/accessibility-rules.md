...
| Agent | Why |
|-------|-----|
| [document-accessibility-wizard](../skills/document-accessibility-wizard.md) | Orchestration and cross-document pattern detection |
| [word-accessibility](../skills/word-accessibility.md) | DOCX-\* rule lookup |
| [excel-accessibility](../skills/excel-accessibility.md) | XLSX-\* rule lookup |
| [powerpoint-accessibility](../skills/powerpoint-accessibility.md) | PPTX-\* rule lookup |
| [pdf-accessibility](../skills/pdf-accessibility.md) | PDFUA.\*, PDFBP.\*, PDFQ.\* lookup |
| [cross-document-analyzer](../skills/cross-document-analyzer.md) | Pattern aggregation across all rule namespaces |
...
Each severity, with its impact on AT users.
...
`skills/kb-accessibility-rules/SKILL.md`
