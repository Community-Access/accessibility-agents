...
| Agent | Why |
|-------|-----|
| [developer-hub](../skills/developer-hub.md) | Reference data for routing and scaffolding decisions |
| [python-specialist](../skills/python-specialist.md) | Python version reference, pyproject.toml patterns, PyInstaller modes, common pitfalls |
| [wxpython-specialist](../skills/wxpython-specialist.md) | wxPython sizer/event/threading cheat sheets, desktop accessibility essentials |
| [desktop-a11y-specialist](../skills/desktop-a11y-specialist.md) | Desktop accessibility API reference, screen reader interaction model |
| [desktop-a11y-testing-coach](../skills/desktop-a11y-testing-coach.md) | Testing quick reference, pywinauto patterns |
| [a11y-tool-builder](../skills/a11y-tool-builder.md) | Python packaging and testing patterns for tool development |
