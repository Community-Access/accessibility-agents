...
| Agent | Why |
|-------|-----|
| [web-csv-reporter](../skills/web-csv-reporter.md) | Maps axe-core rule IDs to Accessibility Insights help URLs in CSV exports |
| [document-csv-reporter](../skills/document-csv-reporter.md) | Maps Office/PDF rule IDs to Microsoft and Adobe help URLs in CSV exports |
| [markdown-csv-reporter](../skills/markdown-csv-reporter.md) | Maps WCAG criteria and markdownlint rules to help URLs in CSV exports |
...
```text
skills/kb-help-url-reference/SKILL.md
```
