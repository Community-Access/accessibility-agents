...
| Agent | Why |
|-------|-----|
| [document-accessibility-wizard](../skills/document-accessibility-wizard.md) | Discovery and delegation for all document scans |
| [document-inventory](../skills/document-inventory.md) | Building file inventories and detecting changed files |
...
Each profile, with severities reported and use case.
...
`skills/kb-document-scanning/SKILL.md`
