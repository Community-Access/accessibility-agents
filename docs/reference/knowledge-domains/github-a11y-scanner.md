...
| Agent | Why |
|-------|-----|
| [scanner-bridge](../skills/scanner-bridge.md) | Primary consumer -- bridges scanner data into the agent ecosystem |
| [web-accessibility-wizard](../skills/web-accessibility-wizard.md) | Auto-detects scanner in Phase 0, correlates findings in Phase 9 |
| [insiders-a11y-tracker](../skills/insiders-a11y-tracker.md) | Discovers scanner-created issues in search patterns |
| [daily-briefing](../skills/daily-briefing.md) | Surfaces scanner findings in daily CI Scanner report section |
| [issue-tracker](../skills/issue-tracker.md) | Recognizes scanner-created issues in Scanner Triage mode |
...
See the complete skill file: [`skills/kb-github-a11y-scanner/SKILL.md`](../../skills/kb-github-a11y-scanner/SKILL.md)
