...
Before 7.0, nine prompt files provided one-click workflows. Those workflows are now phases of this skill; describe the task and the wizard runs the right one.
