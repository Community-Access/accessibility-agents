...
Each skill, with its purpose.

| Skill | Purpose |
|-------|---------|
| [python-development](../knowledge-domains/python-development.md) | Python version reference, pyproject.toml patterns, PyInstaller modes, wxPython cheat sheets |
