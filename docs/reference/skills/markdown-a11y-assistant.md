...
Before 7.0, four prompt files provided one-click workflows. Those are now modes of this skill: a full guided audit, a quick errors-only triage, a fix pass, and CSV export. Say which you want.
