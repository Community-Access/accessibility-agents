...
> Original path: `docs/HOOKS-CROSS-PLATFORM-STRATEGY.md`.
>
...
Each platform, with its primary location, secondary locations and notes.
...
Each type, with its VS code 1.110, claude code, gemini CLI and description.
