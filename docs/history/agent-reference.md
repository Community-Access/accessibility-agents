...
> Original path: `docs/agent-reference.md`.
>
> Moved from `CLAUDE.md` in 7.0. The enforcement contract now lives in
> `AGENTS.md`, which `CLAUDE.md` imports. This file is the long-form reference:
> the full agent roster, knowledge domains, decision matrix and client notes.
> Report requirements and the non-negotiable standards moved to
> `skills/a11y-core/SKILL.md`.
