...
> Original path: `docs/deployment-layout.md`.
...
Each resource, with its claude code CLI, VS code copilot, copilot CLI, codex CLI, gemini CLI and GitHub coding agent.
...
Each resource, with its claude code CLI, VS code copilot, copilot CLI, codex CLI and gemini CLI.
...
- `github.copilot.chat.agentDebugLog.enabled` (agent debug logging -- documented in the [Configuration guide](../reference/configuration.md#agent-debug-settings-vs-code-1112) as optional)
- `chat.autopilot.enabled` (autonomous operation -- documented in [Configuration guide](../reference/configuration.md#permission-levels-vs-code-1112) as optional)
- `chat.useCustomizationsInParentRepositories` (monorepo support -- documented in [Configuration guide](../reference/configuration.md#monorepo-configuration-vs-code-1112) as optional)
- `chat.imageSupport.enabled` (image analysis -- documented in [Configuration guide](../reference/configuration.md#image-analysis-settings-vs-code-1112) as optional)

Those settings are recommended but not required. They are documented in the [Configuration guide](../reference/configuration.md) for users who want to opt in.
