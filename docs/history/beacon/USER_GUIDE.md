...
> Original path: `docs/beacon/USER_GUIDE.md`.
>
...
Each component, with its minimum version.
...
Each column, with its description.
...
Each setting, with its description.
