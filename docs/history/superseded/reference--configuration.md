...
Each level, with description and use case.
...
This discovers agent customizations from parent folders up to the `.git` root. See [Advanced Scanning Patterns](../guides/advanced/advanced-scanning-patterns.md#monorepo-customization-discovery-vs-code-1112) for details.
...
See [Agent Debug Panel Guide](../history/agent-debug-panel.md) for full details.
