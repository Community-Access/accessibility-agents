...
Each capability, with its claude code, GitHub copilot, gemini CLI and codex CLI.

| Capability | Claude Code | GitHub Copilot | Gemini CLI | Codex CLI |
|-----------|------------|----------------|------------|-----------|
| Agent format | `skills/*.md` | `skills/*.agent.md` | `.gemini/extensions/*/skills/*/SKILL.md` | `.codex/AGENTS.md` |
...
| Skills | N/A | `skills/*/SKILL.md` | Extension skills | N/A |
...
The Agent Skills in `skills/` serve as platform-independent knowledge:
