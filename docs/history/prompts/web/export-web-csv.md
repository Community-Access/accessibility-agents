...
> Original path: `docs/prompts/web/export-web-csv.md`.
...
| Agent | Role |
|-------|------|
| [web-csv-reporter](../../../reference/skills/web-csv-reporter.md) | Internal agent that generates the CSV files |
| [web-accessibility-wizard](../../../reference/skills/web-accessibility-wizard.md) | Orchestrator that can trigger CSV export after an audit |
