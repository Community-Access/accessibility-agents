...
> Original path: `docs/prompts/documents/audit-changed-documents.md`.
...
| [document-inventory](../../../reference/skills/document-inventory.md) | Runs the git diff and identifies changed files |
| [cross-document-analyzer](../../../reference/skills/cross-document-analyzer.md) | Performs Fixed/New/Persistent/Regressed classification |
