...
> Original path: `docs/prompts/documents/compare-audits.md`.
...
| Agent | Role |
|-------|------|
| [document-accessibility-wizard](../../../reference/skills/document-accessibility-wizard.md) | Reads both reports and generates the comparison |
| [cross-document-analyzer](../../../reference/skills/cross-document-analyzer.md) | Performs the classification and velocity calculations |
