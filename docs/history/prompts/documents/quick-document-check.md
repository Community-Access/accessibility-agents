...
> Original path: `docs/prompts/documents/quick-document-check.md`.
...
| Agent | Role |
|-------|------|
| [document-accessibility-wizard](../../../reference/skills/document-accessibility-wizard.md) | Runs the minimal-profile scan and formats the result |
