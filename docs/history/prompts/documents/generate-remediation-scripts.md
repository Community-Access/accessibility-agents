...
> Original path: `docs/prompts/documents/generate-remediation-scripts.md`.
...
| Agent | Role |
|-------|------|
| [document-accessibility-wizard](../../../reference/skills/document-accessibility-wizard.md) | Analyzes the audit and generates the scripts |
