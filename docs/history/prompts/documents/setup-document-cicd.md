...
> Original path: `docs/prompts/documents/setup-document-cicd.md`.
...
Each profile, with rules, severities and best for.
...
| Agent | Role |
|-------|------|
| [document-accessibility-wizard](../../../reference/skills/document-accessibility-wizard.md) | Generates all pipeline and config files |
| [document-inventory](../../../reference/skills/document-inventory.md) | Used to understand the document structure for CI config |
