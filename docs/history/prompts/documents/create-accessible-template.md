...
> Original path: `docs/prompts/documents/create-accessible-template.md`.
...
| Agent | Role |
|-------|------|
| [document-accessibility-wizard](../../../reference/skills/document-accessibility-wizard.md) | Provides the guidance and optional config generation |
| [word-accessibility](../../../reference/skills/word-accessibility.md) | Word-specific rule knowledge |
| [excel-accessibility](../../../reference/skills/excel-accessibility.md) | Excel-specific rule knowledge |
| [powerpoint-accessibility](../../../reference/skills/powerpoint-accessibility.md) | PowerPoint-specific rule knowledge |

## Related Prompts

- [audit-single-document](./audit-single-document.md) - scan the template after creating it
- [office-scan-config](../../../reference/skills/office-scan-config.md) - configure what gets checked during scanning
