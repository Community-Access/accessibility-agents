...
> Original path: `docs/prompts/documents/generate-vpat.md`.
...
| Agent | Role |
|-------|------|
| [document-accessibility-wizard](../../../reference/skills/document-accessibility-wizard.md) | Orchestrates VPAT generation from audit data |
| [cross-document-analyzer](../../../reference/skills/cross-document-analyzer.md) | Provides the per-criterion analysis needed for conformance levels |
