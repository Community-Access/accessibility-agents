...
> Original path: `docs/prompts/documents/export-document-csv.md`.
...
| Agent | Role |
|-------|------|
| [document-csv-reporter](../../../reference/skills/document-csv-reporter.md) | Internal agent that generates the CSV files |
| [document-accessibility-wizard](../../../reference/skills/document-accessibility-wizard.md) | Orchestrator that can trigger CSV export after an audit |
