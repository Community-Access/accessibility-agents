...
> Original path: `docs/cross-platform-tool-mapping.md`.
...
Each platform, with its agent location, tool declaration format and file extension.
...
Each operation, with its claude code, copilot CLI, VS code copilot, codex and notes.
...
Each tool, with its platform and purpose.
...
Each row, with use this, instead of and reason.
