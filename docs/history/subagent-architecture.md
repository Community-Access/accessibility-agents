...
> Original path: `docs/subagent-architecture.md`.
...
Each aspect, with its decision and rationale.
...
- [Configuration Guide](../reference/configuration.md) — How users set subagent behavior
