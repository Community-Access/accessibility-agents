...
> Original path: `docs/guides/vscode-builtin-skill-comparison.md`.
>
...
Each domain, with its VS code built-in and accessibility agents.
...
Each criteria, with its VS code built-in and accessibility agents.
...
Each feature, with its VS code built-in and accessibility agents.
...
Each tool, with its VS code built-in and accessibility agents.
...
Each capability, with its VS code built-in and accessibility agents.
...
Each enforcement, with its VS code built-in and accessibility agents.
...
- **New to Accessibility Agents?** Start with [Getting Started](../getting-started/README.md)
...
- [Context Management](../guides/context-management.md) - Session forking and compaction
- [Lifecycle Hooks](../reference/hooks.md) - Proactive accessibility enforcement
