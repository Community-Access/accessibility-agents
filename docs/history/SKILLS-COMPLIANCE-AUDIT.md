...
> Original path: `docs/SKILLS-COMPLIANCE-AUDIT.md`.
...
Each row, with its #, skill, folder, name match, description under 200c, body OK, links OK, WCAG OK, passed and notes.
...
Each phase, with its status, completion, owner and ETA.
