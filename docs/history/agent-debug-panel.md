...
> Original path: `docs/guides/agent-debug-panel.md`.
>
...
- [Lifecycle Hooks Guide](../guides/hooks.md) - Deep dive on the three-hook enforcement system
- [Context Management Guide](../guides/context-management.md) - Using `/compact` effectively
- [Agent Customization](../reference/skills/README.md) - Creating custom agents and skills
