...
Applies to files matching `**/*.{md,agent.md}`.
...
Each preferred term, with do NOT use and definition.
...
Each preferred term, with its definition.
...
Each preferred term, with file extension and do NOT use.
