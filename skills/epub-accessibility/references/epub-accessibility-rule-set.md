# ePub Accessibility reference: EPUB Accessibility Rule Set

Part of the `epub-accessibility` skill. Read this only when the task reaches these sections.

## EPUB Accessibility Rule Set

### Errors - Block assistive technology access

Each row, with its ID, name, description and WCAG mapping.
...
Each row, with its ID, name and description.
